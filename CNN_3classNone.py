'''
!!! ไฟล RNN_3classNone.py ควรอยู่ที่เดียวกันกับโฟลเดอร์ DataSetLab เพื่อให้ง่ายต่อการเรียกใช้โฟลเดอร์ DataSetLab !!!
...
for build in range( n_folds ) :
    model = keras.Sequential(
        [
            ...
            layers.Conv1D( filters = 1, kernel_size = 100, activation = "relu" ),
