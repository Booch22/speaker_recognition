'''
โปรแกรมบันทึกข้อมูลเสียงและเทรนด์โมเดล
เป็นโปรแกรมที่จะบันทึกข้อมูลเสียงของผู้พูด แล้วนำข้อมูลเสียงมาเทรนด์กับโมเดลเพื่อนำมาใช้งานจริง
1. กดปุ่ม Add speaker เพื่อเพิ่มผู้พูด (สามารถเพิ่มกี่คนก็ได้)
2. กดปุ่ม Record เพื่อเริ่มการบันทึกเสียงผู้พูด
3. กดปุ่ม Record background noise เพื่อบันทึกเสียงพื้นหลัง
4. กดปุ่ม Train เพื่อเทรนด์โมเดลกับข้อมูลเสียงที่ได้ทำการบันทึก
5. เมื่อเทรนด์เสร็จต้องตั้งชื่อไฟล์โมเดลก่อนทำการบันทึก
'''
