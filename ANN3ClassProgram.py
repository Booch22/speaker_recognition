'''
โปรแกรมนี้เป็นโปรแกรมสำหรับเทรนด์โมเดลกับข้อมูลเสียงที่ได้ทำการบันทึกจากผู้พูด
1. กดปุ่ม Add speaker เพื่อเพิ่มผู้พูด (เพิ่มกี่คนก็ได้)
2. กดปุ่ม Record เพื่อเริ่มบันทึกเสียงผู้พูด
3. หลังกดปุ่ม Record โปรแกรมจะแสดงข้อความ 
   เช่น Say open ให้พูดเปิดประตู
       Say close ให้พูดปิดประตู
4. กดปุ่ม Record background noise เพื่อบันทึกเสียงพื้นหลัง ให้รอโปรแกรมบันทึกเสียงจนครบ 5 รอบ โดยจะแสดงข้อความขึ้นมา
    เช่น Recording backgroud noise
5. กดปุ่ม Train เพื่อนำข้อมูลเสียงที่บันทึกมาเทรนด์กับโมเดล
6. เมื่อเทรนด์เสร็จตั้งชื่อไฟล์ก่อนทำการกดบันทึกข้อมูล
'''
